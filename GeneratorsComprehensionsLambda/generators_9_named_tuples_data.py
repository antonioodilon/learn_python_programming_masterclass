...
# The first argument ('Plant') is the name of the tuple.
# The second argument is a list of the names we want to use for each of the
# fields in the named tuple.

# For example: 'name' = "Andromeda", 'scientific_name' = "Pieris japonica",
# 'lifecycle' = "Evergreen", 'plant_type' = "Shrub"

PlantDetails = namedtuple('PlantDetails', ['scientific_name', 'lifecycle', 'plant_type'])
# PlantDetails doesn't have a name like Plant does because it is used in a dictionary,
# and the name is the dictionary key.
